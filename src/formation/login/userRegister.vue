...
.yes {
  width: 40%;
  height: 20%;
  background: linear-gradient(to right, rgba(243, 188, 211), rgba(205, 214, 242));
  border-radius: 5%;
  display: flex;
  justify-content: center;
  align-items: center;
